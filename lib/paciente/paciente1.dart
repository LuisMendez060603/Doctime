  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        // Escala general basada en ancho de la ventana
        double scale = constraints.maxWidth / 400; // 400 es ancho base
        scale = scale < 0.8 ? 0.8 : scale; // mínimo 0.8
        scale = scale > 1.5 ? 1.5 : scale; // máximo 1.5
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Center(child: Image.asset('img/Imagen3.png', width: 30 * scale, height: 30 * scale)),
          ),
          SizedBox(height: 10 * scale),
          Text(
            'Historial de citas',
